...
#define GPIOA_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<0));(RCC->RCC_AHB1RSTR&=~(1<<0));}while(0)
#define GPIOB_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<1));(RCC->RCC_AHB1RSTR&=~(1<<1));}while(0)
#define GPIOC_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<2));(RCC->RCC_AHB1RSTR&=~(1<<2));}while(0)
#define GPIOD_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<3));(RCC->RCC_AHB1RSTR&=~(1<<3));}while(0)
#define GPIOE_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<4));(RCC->RCC_AHB1RSTR&=~(1<<4));}while(0)
#define GPIOF_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<5));(RCC->RCC_AHB1RSTR&=~(1<<5));}while(0)
#define GPIOG_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<6));(RCC->RCC_AHB1RSTR&=~(1<<6));}while(0)
#define GPIOH_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<7));(RCC->RCC_AHB1RSTR&=~(1<<7));}while(0)
#define GPIOI_PCLOCK_DI()	do {(RCC->RCC_AHB1RSTR|=(1<<8));(RCC->RCC_AHB1RSTR&=~(1<<8));}while(0)
